...
export default function Hero() {
  return (
    <section className="-z-50 top-20 relative flex flex-col lg:flex-row items-center justify-between h-screen bg-gray-50 overflow-hidden">
      ...
      <div className="absolute -left-5  top-1/2 -translate-y-1/2 lg:top-50 lg:bottom-0 lg:left-0 opacity-80 lg:opacity-100 z-1">
        ...
        <img
          ...
          className="w-24 lg:w-28 lg:object-cover" // Adjust size and rotation as needed
        />
      </div>
      <div className="lg:relative absolute top-20 xl:left-10 lg:top-0 z-10 w-full lg:w-1/2 p-6 md:p-12 lg:pl-24 lg:py-20 flex flex-col justify-center text-center  lg:text-left">
        <p className="text-lg sm:text-2xl text-gray-800 mb-4 z-10">
          — Hello and Welcome,
        </p>
        <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-6xl font-bold text-gray-800 leading-tight mb-4 z-10">
          Plan Your <br />
          <span className="text-orange-600 text-shadow-2xs">
            Dream Wedding
          </span>{" "}
          <br />
          With
