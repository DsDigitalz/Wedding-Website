  ...
  return (
    <section className="bg-gradient-to-r from-white to-[#F8E8D8] py-12 sm:py-16 lg:py-20 relative overflow-hidden" behavior="smooth" id="about">
      ...
      <div className="absolute top-0 right-0 max-w-xs md:max-w-sm z-0 opacity-60">
        <img
          src="aboutimg.png"
          alt="Floral decorative background"
      ...
      >
        {/* Left Card */}
        <motion.div
          className="lg:mt-0 flex flex-col gap-5 bg-white px-6 py-10 sm:p-10 lg:px-16 lg:py-20 shadow-xl rounded-lg max-w-xl mx-auto lg:mx-0 z-10"
        ...
        <div className="relative flex justify-center items-center lg:block">
          <div className="space-y-6 lg:space-y-0 lg:absolute lg:top-0 lg:left-0 lg:w-full lg:h-full">
            {/* Image 1 */}
            <motion.div
              className="relative w-[340px] md:w-80 h-auto mx-auto lg:absolute lg:top-32 lg:-left-40 shadow-2xl"
              variants={itemVariants}
            >
              <img
                src="aboutimg1.png"
            ...
            {/* Image 2 */}
            <motion.div
              className="relative w-[300px] md:w-72 h-auto mx-auto lg:absolute lg:top-40 lg:left-32 shadow-2xl -z-10"
              variants={itemVariants}
            >
              <img
                src="aboutimg2.png"
            ...
            {/* Image 3 */}
            <motion.div
              className="relative w-[300px] md:w-72 h-[380px] mx-auto lg:absolute lg:top-28 lg:right-0 shadow-2xl -z-20"
              variants={itemVariants}
            >
              <img
                src="aboutimg3.png"
