...
const WeddingGallery = () => {
  return (
    <section className="bg-white overflow-hidden pb-10 lg:pb-20" behavoir="smooth" id="gallery">
      {/* Top Image */}
      ...
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row-reverse gap-4 lg:gap-10 justify-between items-center">
          {/* Left Column */}
          <motion.div
          ...
          >
            ...
            <h2 className="text-center lg:text-left text-4xl md:text-5xl font-bold leading-tight mb-2">
              <span className="text-neutral-700 block">
                Our Recent Work best{" "}
                <span className="text-orange-600">wedding gallery</span>
              </span>
            </h2>
          </motion.div>
