      ...
      >
        ...
        <div className="relative flex-1  justify-center w-full max-w-sm sm:max-w-md lg:max-w-[1440px]   mb-10 lg:mb-0">
          ...
          <motion.img
            ...
            className="w-3/4 sm:w-80 lg:w-90 lg:h-110 object-cover rounded-md shadow-lg border-2 border-gray-800 relative z-10"
          ...
          <motion.img
            ...
            className="w-2/3 sm:w-72 lg:w-80 lg:h-90  object-cover rounded-md shadow-xl border-2 border-orange-600 
              absolute -bottom-6 -right-2 sm:-bottom-10 sm:-right-10 z-20 lg:left-50 "
            initial={{ opacity: 0, y: 50 }}
            whileInView={{ opacity: 1, y: 0 }}
        ...
        {/* RIGHT CONTENT */}
        <div className="flex flex-col gap-5 items-center lg:items-start flex-1 w-full max-w-xl space-y-6">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <img src="Bouquet.png " alt="Floral Icon" className="mt-5" />
          </motion.div>

          {/* Heading: lg:text-left for desktop alignment */}
          <motion.h2
            className="text-3xl md:text-4xl text-center mb-0 lg:text-left font-bold text-gray-900 leading-snug"
          ...
          >
            {/* Stat Item 1 */}
            <div className="bg-white shadow-md rounded-md px-4 py-3 sm:px-6 sm:py-4 text-center min-w-[120px] flex-1 sm:flex-none">
